# AI Figure Brief: F030-basic-torus-geometry
...
## Source
- File: `chapters/05-spiral-torus-field.tex`
- Line: 9
...
## Prompt Draft
Create a high-resolution scientific concept illustration titled "F030 — Basic Torus Geometry". The image should visually explain: The major radius, minor radius, angular parameters, and central axis define the basic torus used as the model's geometric language.
