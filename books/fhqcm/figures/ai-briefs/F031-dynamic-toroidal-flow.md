# AI Figure Brief: F031-dynamic-toroidal-flow

## Title
F031 — Dynamic Toroidal Flow

## Caption
Toroidal flow is shown as circulation through center, boundary, return, and renewed emergence.

## Source
- File: `chapters/11-coincidence-coherence-eternal-now.tex`
- Line: 103
...
## Prompt Draft
Create a high-resolution scientific concept illustration titled "F031 — Dynamic Toroidal Flow". The image should visually explain: Toroidal flow is shown as circulation through center, boundary, return, and renewed emergence.
