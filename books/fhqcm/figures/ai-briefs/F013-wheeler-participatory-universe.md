# AI Figure Brief: F013-wheeler-participatory-universe

## Title
F013 — Wheeler Participatory Universe

## Caption
The observer and universe are shown as mutually implicated through information, distinction, question, and response.

## Source
- File: `chapters/03-quantum-observation.tex`
- Line: 71
...
## Prompt Draft
Create a high-resolution scientific concept illustration titled "F013 — Wheeler Participatory Universe". The image should visually explain: The observer and universe are shown as mutually implicated through information, distinction, question, and response.
