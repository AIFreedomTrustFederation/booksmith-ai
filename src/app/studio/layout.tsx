    ...
    <div className="min-h-screen bg-[#06110b] text-[#eef7ea]">
      <header className="sticky top-0 z-50 border-b border-[#20382a] bg-[#06110b]/95 backdrop-blur">
        <div className="mx-auto flex max-w-[1700px] items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
          ...
          <nav aria-label="Booksmith Studio" className="hidden items-center gap-1 rounded-xl border border-[#20382a] bg-[#09170f] p-1 md:flex">
            {navItems.map((item) => (
        ...
        <nav aria-label="Booksmith Studio mobile" className="flex gap-1 overflow-x-auto border-t border-[#172a1f] px-4 py-2 md:hidden">
          {navItems.map((item) => (
